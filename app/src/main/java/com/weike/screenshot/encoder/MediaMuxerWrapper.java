...
public class MediaMuxerWrapper {
    ...
    //private static final String           DIR_NAME        = "TempAVRecSample";
    ...
    public MediaMuxerWrapper(String ext) throws IOException {
        ...
        try {
            mOutputPath = getCaptureFile(AppConfig.VIDEO, ext).toString();
    ...
    public static final File getCaptureFile(final String type, final String ext) {
        final File dir = new File(Environment.getExternalStoragePublicDirectory(type), AppConfig.VIDEO_TEMP);
