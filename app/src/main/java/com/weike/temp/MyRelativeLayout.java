...
public class MyRelativeLayout extends RelativeLayout {
    ...
    public MyRelativeLayout(final Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     //   layoutParams.leftMargin = 500;
       ...
       // setLayoutParams(layoutParams);
        ...
        //  FrameLayout.LayoutParams ivlayoutParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT);
        FrameLayout.LayoutParams ivlayoutParams = new FrameLayout.LayoutParams(200, 200);
        iv = new ImageView(context);
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher);

        iv.setLayoutParams(new ViewGroup.LayoutParams(200, 20));
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (listTvParams != null && ! listTvParams.isEmpty()) {
                    ...
                    if (list != null && ! list.isEmpty()) {
                        ...
                        iv = list.get(num);
                        tv_widths = getMidPiont((int) fX, (int) fY, (int) sX, (int) sY).x - iv.getX();
                        tv_heights = getMidPiont((int) fX, (int) fY, (int) sX, (int) sY).y - iv.getY();

                        oldDist = spacing(event, ptrID1, ptrID2);
                        setTextViewParams(getTextViewParams(iv));
                    }
                }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (iv != null) {
                    ...
                    if (ptrID1 != INVALID_POINTER_ID && ptrID2 != INVALID_POINTER_ID) {
                        ...
                        //                    if (ifIsOnView(iv, new Point(getMidPiont((int) nfX, (int) nfY, (int) nsX, (int) nsY)))) {
                        //                    iv.setX(getMidPiont((int) nfX, (int) nfY, (int) nsX, (int) nsY).x - tv_widths);
                        //                    iv.setY(getMidPiont((int) nfX, (int) nfY, (int) nsX, (int) nsY).y - tv_heights);
                        //                    }
                        //处理旋转模块
                        mAngle = angleBetweenLines(fX, fY, sX, sY, nfX, nfY, nsX, nsY) + defaultAngle;
                        iv.setRotation(mAngle);
     ...
     * @return
     */
    private void saveTextViewparams(ImageView iv) {
        if (iv != null) {
            tvParams = new TextViewParams();
            tvParams.setRotation(0);
            //   tvParams.setTextSize(iv.getTextSize() / 2);
            tvParams.setX(iv.getX());
            tvParams.setY(iv.getY());
            tvParams.setWidth(iv.getWidth());
            tvParams.setHeight(iv.getHeight());
            //  tvParams.setContent(iv.getText().toString());
            tvParams.setMidPoint(getViewMidPoint(iv));
            tvParams.setScale(1);
            tvParams.setTag(String.valueOf((long) iv.getTag()));
            tvParams.setRotation(mAngle);
            //  tvParams.setTextColor(iv.getCurrentTextColor());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //        Log.d(TAG, "onMeasure-->我被调用了哦" + widthMeasureSpec + " " + heightMeasureSpec);
    }
    ...
    public interface MyRelativeTouchCallBack {
        ...
        void onTextViewMoving(ImageView iv);
    ...
    //
    //            //            iv.setEms(1);
    //            iv.setTag(System.currentTimeMillis());
    //            // iv.setText(content);
    //            ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    //            iv.setLayoutParams(params);
    //            // iv.setTextSize(mtextSize);
    //            //  iv.setTextColor(color);
    //            iv.setRotation(rotate);
    //            iv.setX(x - iv.getWidth());
    //            iv.setY(y - iv.getHeight());
    ...
    //                            height = iv.getHeight();
    //                            if (mEvent != null) {
    //                                mTv_width = mEvent.getX() - iv.getX();
    //                                mTv_height = mEvent.getY() - iv.getY();
    //                            }
    //                            mflag = true;
    //                            break;
    //                        case MotionEvent.ACTION_POINTER_DOWN:
    ...
    //                            mflag = false;
    //                            //
    //                            mTv_widths = getMidPiont((int) mfX, (int) mfY, (int) msX, (int) msY).x - iv.getX();
    //                            mTv_heights = getMidPiont((int) mfX, (int) mfY, (int) msX, (int) msY).y - iv.getY();
    //                            //
    ...
    //                                iv.setX(mEvent.getX() - mTv_width);
    //                                iv.setY(mEvent.getY() - mTv_height);
    //                                //通知调用者我在平移
    //                                if (myRelativeTouchCallBack != null)
    //                                    myRelativeTouchCallBack.onTextViewMoving(iv);
    //                            }
    //
    ...
    //
    //                                //如果两点中点在该View上,则考虑两个点也可以拖动该View操作
    //                                iv.setX(getMidPiont((int) nfX, (int) nfY, (int) nsX, (int) nsY).x - mTv_widths);
    //                                iv.setY(getMidPiont((int) nfX, (int) nfY, (int) nsX, (int) nsY).y - mTv_heights);
    //                                //处理旋转模块
